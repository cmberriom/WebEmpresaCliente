...
<html>
    <jsp:include page="/header.jsp">
        <jsp:param name="title" value="Crear empresa"/>
    </jsp:include>
    <br /><br /><br /><br /><br />
    <body>
        <p>
        ...
        <form method="POST" action="EmpresaController" class="w3-container w3-card-4 w3-light-grey w3-text-red w3-margin">
            <h2 class="w3-center">Ingrese la información de la empresa nueva</h2>
            <div class="w3-row w3-section">
                <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-address-book-o"></i></div>
                <div class="w3-rest">
                    <input class="w3-input w3-border" name="CompanyNIT" type="text" placeholder="NIT" required>
                </div>
            </div>
            <div class="w3-row w3-section">
                <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-institution"></i></div>
                <div class="w3-rest">
                    <input class="w3-input w3-border" name="Name" type="text" placeholder="Nombre" required>
                </div>
            </div>
            <div class="w3-row w3-section">
                <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-home"></i></div>
                <div class="w3-rest">
                    <input class="w3-input w3-border" name="Address" type="text" placeholder="Dirección" required>
                </div>
            </div>
            <div class="w3-row w3-section">
                <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-phone"></i></div>
                <div class="w3-rest">
                    <input class="w3-input w3-border" name="Phone" type="text" placeholder="Teléfono" required>
                </div>
            </div>
            <input type='hidden' id='action' name='action' value='createCompany'/>
